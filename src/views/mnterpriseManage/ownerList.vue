...
<script>
import { getOwnerList } from '@/api/equipment'
...
export default {
  ...
  methods: {
    ...
    async getOwnerList() {
      const res = await getOwnerList({ filters: {}, sorts: {}, size: this.size, page: this.page })
      if (res.code === 0) {
